...
- Se ajusta componente ActividadDidactica 
...
- Implementación de selección aleatoria de preguntas a partir de un banco de preguntas en el componente 'actividad'
- Adición de efectos de sonido en el componente 'actividad'
- Implementación de círculo de progreso animado en el componente 'actividad-resultados'
